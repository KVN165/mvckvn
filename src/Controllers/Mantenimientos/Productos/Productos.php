...
const SESSION_PRODUCTOS_DATA = "productos_search_data";
...
class Productos extends \Controllers\PublicController{
    ...
    private function getSessionSearchData(){
        ...
        if (isset($_SESSION[SESSION_PRODUCTOS_DATA])){
            return $_SESSION[SESSION_PRODUCTOS_DATA];
        }
        return "";
    }

    private function setSessionSearchData($search){
        $_SESSION[SESSION_PRODUCTOS_DATA] = $search;
    }
}